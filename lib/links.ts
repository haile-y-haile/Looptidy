/** Public URLs for marketing, support, and legal pages. */
export const CONTACT_EMAIL = 'hello.hailelabs@gmail.com';

export const links = {
  githubRepo: 'https://github.com/haile-y-haile/Looptidy',
