    ...
    decisions: [
      {
        id: 'd1',
        loopId: 'loop-4',
        title: 'Which PM tool should the team adopt?',
        summary: 'Compare Linear, Jira, and Notion for engineering workflow.',
        status: 'decided',
        options: [],
        finalDecision: 'Linear — best fit for engineering workflow and sprint planning',
        rationale: 'Best fit for engineering workflow and sprint planning',
        impact: 'Team will migrate sprints to Linear next month',
        riskLevel: 'low',
        decidedAt: daysAgo(1),
        owner: 'Team vote',
        createdAt: daysAgo(2),
